...
// Updated interface to include physicalReturnLabelFiles from backend
interface Customer {
  firstName: string
  lastName: string
  phone: string
...
interface PackageItem {
  packageNumber: string
  barcodeImages: string[] // URLs from backend (uploaded images)
}
...
interface OrderData {
  ...
  pricing: Pricing
  _id: string
  // Added from backend after file upload
  physicalReturnLabelFiles?: string[] // Array of file URLs returned by backend
}
...
export function SummaryReview({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Physical Return Label Files - NEW SECTION */}
